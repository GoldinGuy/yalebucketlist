					...
					<form onSubmit={handlePasswordSubmit} className="space-y-6">
						<div>
							<input
								...
								className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-center text-lg"
								style={{ fontFamily: "Georgia, serif" }}
								autoFocus
							/>
						</div>
						...
						<button
							type="submit"
							className="w-full bg-blue-900 hover:bg-blue-800 text-white font-semibold py-3 px-6 transition-all duration-200"
							style={{ fontFamily: "Georgia, serif" }}
						>
							Enter
						</button>
			...
			<div className="container mx-auto px-4 py-12">
				<div className="text-center mb-12">
					...
					<p className="text-lg  text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
						Follow this unserious list at your own risk. Completing all of these
						may result in poor grades, social headaches, or other consequences…
					</p>
